...
import { createToolBezier } from '@/composables/createToolBezier'
...
const bezier = createToolBezier({
    board,
    active: computed(() => activeTool.value === 'bezier'),
})
...
board.addPlugin(transform, zoom, pan, rect, ellipse, rotate, brush, history, bezier)
    ...
    <div class="w-dvw h-dvh">
        ...
        >
            ...
            <div class="fixed top-0 right-0 flex gap-2 z-20 p-4">
                ...
                <cd-tool-bezier-options v-if="activeTool === 'bezier'" />
                ...
                <cd-btn
                    size="sq-md"
                    :color="activeTool === 'ellipse' ? 'primary' : 'body-900'"
                ...
                <cd-btn
                    size="sq-md"
                    :color="activeTool === 'bezier' ? 'primary' : 'body-900'"
                    @click="activeTool = 'bezier'"
                >
                    <cd-icon name="mdi:vector-bezier" />
                </cd-btn>
